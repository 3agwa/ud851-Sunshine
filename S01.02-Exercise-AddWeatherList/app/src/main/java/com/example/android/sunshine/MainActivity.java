...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
         * findViewById does exactly as the name implies:
         * It gets a view from your XML layout by its ID, and stores it for you in a Java object
         */
