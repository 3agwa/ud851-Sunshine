...
public class MainActivity extends AppCompatActivity {
    ...
    private ProgressBar showHideProgressBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mErrorMessageTextView = (TextView) findViewById(R.id.error_loading_content);

        // COMPLETED (17) Find the ProgressBar using findViewById
        showHideProgressBar = (ProgressBar) findViewById(R.id.show_hide_bar);
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        {
            super.onPreExecute();
            showHideProgressBar.setVisibility(View.VISIBLE);
        }
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            showHideProgressBar.setVisibility(View.INVISIBLE);
